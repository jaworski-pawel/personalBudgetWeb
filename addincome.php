  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="addincome.php"><span class="glyphicon glyphicon-export"></span>Dodaj przychód</a></li>
          ...
          <diV class="well col-sm-6 col-sm-offset-3">
            <form method="post">
              <fieldset class="operation">
                <legend><span class="glyphicon glyphicon-export"></span>Dodaj przychód</legend>
